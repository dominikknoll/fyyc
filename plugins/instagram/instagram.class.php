...
class Instagram {
   ...
   * @return mixed
   */
  public function getUserFeed($limit = 300) {
   ...
   * @return mixed
   */
  public function getUserMedia($id = 'self', $limit = 1000) {
  ...
  private function _makeCall($function, $auth = false, $params = null, $method = 'GET') {
    if (false === $auth) {
      ...
      if (true === isset($this->_accesstoken)) {
        $authMethod = '?access_token=36880628.8371be1.200adb20b4fd45e3ac5c94fb9eea7765';
      } else {
      	echo("ladida");
